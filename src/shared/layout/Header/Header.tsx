    ...
    const learnLinks: EuiListGroupItemProps[] = [
        {
            ...
            href:
                'https://www.elastic.co/guide/en/apm/server/master/index.html',
            target: '_blank'
        },
        {
        ...
        },
        {
            label: 'Blogs',
            href:
                'https://www.elastic.co/search?fv-website_area=blog&q=apm&size=20',
            target: '_blank'
        },
        {
            label: 'Webinars',
